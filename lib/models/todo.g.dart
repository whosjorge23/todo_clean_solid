...
int _todoEstimateSize(
  ...
  bytesCount += 3 + object.dateTimestamp.length * 3;
...
const _TodopriorityValueEnumMap = {
  ...
  r'Maximum': TodoPriority.Maximum,
};
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dateTimestamp',
        value: '',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> dateTimestampIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'dateTimestamp',
        value: '',
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDateTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTimestamp', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDateTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDateTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTimestamp', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDateTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTimestamp', Sort.desc);
    });
  }
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, String, QQueryOperations> dateTimestampProperty() {
    return QueryBuilder.apply(this, (query) {
